...
function AddNewDriverModal({togleEdit,isOpen}) {
      ...
      const onSubmitDataMaster = async (e) =>{
        e.preventDefault();
         try {
            ...
            const data = {username,age,password,prePassword,workPlace_id,fullname,tableNumeber,gradeNumber,phoneNumber}
             const res = await axios.post('http://localhost:8080/api/driver/addDriver',data,{headers});
