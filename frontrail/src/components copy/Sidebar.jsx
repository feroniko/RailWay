        ...
        <div className="top">
          ...
          <div  className={navbarState===true ? "links show":"links"}>
            <ul>
              ...
              <Link to={'/admin_board/masters'}>
              <li
                className={currentLink === 2 ? "active" : "none"}
                onClick={() => setCurrentLink(2)}
              >
                <a href="/admin_board/masters">
                  <AiOutlineUserDelete />
                  <span> Masters</span>
                </a>
              </li>
              </Link>
              <Link to={'/admin_board/workers'}>
              <li
