...
import AddNewDriverModal from './AddModalDriver/AddNewDriverModal';
  ...
  return (
    <div>
      ...
      <div className='table-com'>
              ...
              <tbody>
               {user.map((item, index)=>(
                    <tr key={item.id} className="table_hover">
                      ...
                      <td>
                      <div >
                        <FiEdit2  className="icon_for_edit" onClick={() => history.push("/admin_board/drivers/driver_id=" + item.id)}/>
        ...
        <div>
          <AddNewDriverModal togleEdit={handleOpenModal}  isOpen={modalVisible}/>
        </div>
      </div>
